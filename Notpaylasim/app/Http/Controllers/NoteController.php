...
class NoteController extends Controller
{
    ...
    {
        $datalist = Notes::where('user_id', Auth::id())->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Notes $note,$id)
    {
        $data = Notes::find($id);
        $datalist = Category::with('children')->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Notes $note,$id)
    {
        $data = Notes::find($id);
     ...
     */
    public function destroy(Notes $note,$id)
    {
